...
const Header = () => {
  ...
  return (
    <header 
      className={`sticky top-0 z-[3000] transition-all duration-300 ${
        isScrolled 
          ? 'bg-white/30 backdrop-blur-3xl shadow-sm border-b border-white/20' 
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center h-9 w-9 rounded-xl bg-white/50 hover:bg-iv-indigo/10 hover:text-iv-indigo border border-gray-200/60 transition-colors"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => navigate('/settings')} className="inline-flex items-center justify-center h-9 w-9 rounded-full hover:bg-gray-100">
            ...
            <div className="relative">
              <button onClick={() => setProfileOpen((o) => !o)} className="flex items-center gap-2">
                ...
                <div className="h-8 w-8 bg-indigo-600 rounded-full flex items-center justify-center overflow-hidden">
                  {user?.profile?.avatar ? (
