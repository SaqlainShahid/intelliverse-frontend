...
export default { list, getCategories, getById, create, update, remove, join, leave, generateQr, checkIn, submitFeedback, getFeedback, sendReminders, resolveByCode, downloadIcs, downloadAttendeesCsv, announce };
